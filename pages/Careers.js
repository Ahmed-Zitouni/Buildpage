...
export default function Careers() {
  return (
    <>
      ...
      <MainBlock
        buttonDisplay={false}
        title="Working at Buildpage"
        text="We appreciate everyone that has joined us to make Buildpage what it is today. To show our appreciation we offer perks such as:"
      />
      <CareerCards />
      <MainBlock
        name="position"
